 ...
 *
 *  <br><br>
 *   Log4j2提供的JUL Adapter可以在不改变现有JUL代码的前提下，将JUL转为Log4j2的格式<br>
 *   按照现在的log4j2的JUL Adapter<a href="https://logging.apache.org/log4j/2.x/log4j-jul/index.html">官方配置文档</a>会报错，<br/>
 *   原因见<a href="https://issues.apache.org/jira/browse/LOG4J2-2025">这里</a>，会在未来的3.0版本中发布，现在最新版本为2.14<br/>
 *   解决方法为<a href="https://stackoverflow.com/questions/55832210/log4j-jdk-logging-adapter-apply-logmanager-system-property-late-in-the-startup">stackoverflow回答</a><br/>
 *   直接去已经官方GitHub仓库找到这个类，直接copy过来，然后把logging.properties中的handler改为这个类的完全限定名，去掉-Djava.util.logging.manager即可<br/>
 *   配置完成之后可以在log4j2.xml中进行日志级别的控制
 */
